...
T0_0=[1 0 0 0.3; 
      ...
      0 0 1 0;
      0 0 0 1];
T0_6=T0_0*T1*T2_4*T5*T6;

p1=T0_6(1:3,4);


ry=atan2(-T0_6(3,1),sqrt(T0_6(1,1)^2+T0_6(2,1)^2));
if ry==pi/2
    rz=0;
    ...
    if ry==-pi/2
        ...
        rz=atan2(T0_6(2,1)/cos(ry),T0_6(1,1)/cos(ry));
        rx=atan2(T0_6(3,2)/cos(ry),T0_6(3,3)/cos(ry));
    end
end
p2=[rz;ry;rx];
p=[p1;p2];