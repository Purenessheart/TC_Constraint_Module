...
theta(5,1:2)=atan2(t211,t21);
theta(5,3:4)=-atan2(t211,t21);

t22=ax*sin(theta(1,5))-ay*cos(theta(1,5));
t212=sin(theta(6,4))*(oy*cos(theta(1,4)) - ox*sin(theta(1,4))) - cos(theta(6,4))*(ny*cos(theta(1,4)) - nx*sin(theta(1,4)));
% if abs(t22-1)<10^(-5)
%     t22=1;
% else
%     if abs(t22+1)<10^(-5)
...
theta(5,5:6)= atan2(t212,t22);
theta(5,7:8)=-atan2(t212,t22);
...
theta(2,1:4)=atan2((n1*(a(2)+a(3)*cos(theta(3,1)))-m1*(a(3))*sin(theta(3,1))),(m1*(a(2)+a(3)*cos(theta(3,1)))+n1*(a(3))*sin(theta(3,1))));
theta(2,2:3)=atan2((n1*(a(2)+a(3)*cos(theta(3,3)))-m1*(a(3))*sin(theta(3,3))),(m1*(a(2)+a(3)*cos(theta(3,3)))+n1*(a(3))*sin(theta(3,3))));
